...
export default function Page() {
    ...
    return (
        <div className="flex flex-col items-center space-y-3 bg-purple-100 min-h-screen">
            <div className="text-center">
                <br />
                <br />
                <h1 className="font-display text-5xl text-purple-900 font-black">the results are out.</h1>
                <br></br>
                <p className="text-2xl text-purple-900 font-semibold">here are your top three.</p>
            </div>
